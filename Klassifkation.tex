...
\section{CNN with SVHN Alone}
    Notiz: Ich muss irgendetwas finden, was die Trainingszeit verkürzt! Interessanterweise 
    ist dieses Netz nicht besser als alle bisherigen TF-Netze, obwohl es ohne TF allein 
    trainiert wird. Es hat eine Accuracy von circa 17\%, obwohl es quasi aus dem Netz kopiert ist. Dieses Netz ist kein Direct Cascade, da Batch Normalization zwischen 
...
\section{Schnelleres Training V1}
    ...
    von genau dem davorgehenden Zeitpunkt und dient als neuer Input. 
